...
saveRDS(ranger_ff, "cor_ranger_pred.rds")
...
|                  | ranger_imp|
|:-----------------|----------:|
|orig_amounts      |  14.620791|
|orig_days         |   9.289237|
|comm_out_state    |   3.163966|
|aadt              |   2.477838|
|ind_agri          |   2.228688|
|ind_other         |   2.159864|
|pop_16yrover      |   2.143753|
|inde_ed_meds      |   2.021736|
|ncat_pjt_type     |   1.994667|
|comm_pubtransport |   1.878972|
:end:
...
#+begin_src R
ff <- df %>%
  mutate(pred = ranger_final$predictions[, 2]) %>%
